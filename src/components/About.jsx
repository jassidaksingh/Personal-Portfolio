  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} text-black dark:text-secondary`}>Introduction</p>
        <h2 className={`${styles.sectionHeadText} text-black dark:text-white`}>Overview.</h2>
      </motion.div>

      <motion.p
        variants={fadeIn("", "", 0.1, 1)}
        className='mt-4 text-black dark:text-[#D3D3D3] text-[17px] max-w-3xl leading-[30px]'
      >
        ...
        and React. I leverage Tailwind CSS for styling, Git for version 
        control, and Figma for UI design. Let's work together to bring your 
